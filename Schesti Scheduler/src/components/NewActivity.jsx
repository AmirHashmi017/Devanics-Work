...
const NewActivity = () => {
  ...
  const saveTaskData = () => {
    ...
    console.log("Saving tasks data:App", tasks);
  ...
  useEffect(() => {
    ...
    const initialTimeoutId = setTimeout(() => {
      ...
      if (projectTasks && projectTasks.length > 0) {
        ...
        console.log("Updated project tasks", projectTasks);
      }

      console.log("sdsd", projectTasks, tasks);
      ...
      intervalId = setInterval(() => {
        ...
        console.log("Polling every 2 seconds:", currentTasks);
        if (!arraysEqual(currentTasks, tasks)) {
          console.log("Arrays have changed.");
          setTasks(currentTasks);
          updateTasks(currentTasks);
