...
export default function Role() {
  ...
  const handleSave = async () => {
    try {
      if (isEditing) {
        await axios.patch(backend_url+`/roles/${role._id}`, {
          userId,
          Name: role.Name,
          parentRole: role.parentRole,
        });
      } else {
        await axios.post(backend_url+"/roles", {
          userId,
          Name: role.Name,
          parentRole: role.parentRole,
        });
            ...
            <div className="final__bg__09">
              <div className="seaech__box___00">
                <div className="row flex-column dashboardpage   flex-md-row">
                  ...
                  <div className=" col-md-7 col-lg-6 justiClass col-xl-5 col-12 justify-content-end d-flex">
                    <Button
                      style={{
                        background: "#007AB6",
                        width: "217px",
          ...
          <div className="s__set__09w">
            ...
            <FormControl fullWidth margin="normal">
              ...
              >
                {roles.length > 0 ? (
                  [
                    <MenuItem key="no-parent" value="No Parent">
                      No Parent
                    </MenuItem>,
                    ...roles.map((r) => {
                      return (
