...
export const taskTypes = [
  ...
  { id: "narrow", label: "Narrow", backgroundColor: "#FFD700" },
  { id: "progress", label: "Progress", backgroundColor: "#00CED1" },
  { id: "round", label: "Rounded", backgroundColor: "#8FBC8F" },
];

export function getTypedData(tasks) {
