...
import { ICreateAd } from 'src/interfaces/ad.interface';
...
import { validateImageDimensions } from 'src/utils/file-validator';
...
const CreateAd = () => {
  ...
  const UploadHandler = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const validationResult = await validateImageDimensions(
        e.target.files![0],
        {
          requiredHeight: 190,
          requiredWidth: 1296,
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={twMerge(minHeading, 'mt-1')}>
                          Files should be in jpeg, png, jpg, gif & should be
                          less than 5MB.
                        </p>
                        {imageUploading ? (
                          <label
