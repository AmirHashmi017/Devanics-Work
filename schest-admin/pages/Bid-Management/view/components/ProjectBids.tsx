...
import CustomButton from 'src/components/CustomButton/white';
            ...
            {biddings.length > 0 &&
              biddings.map((bid) => {
                ...
                return (
                  <div
                    key={bid._id}
                    className={`mt-3 h-fit rounded-lg ${
                  ...
                  >
                    <div className="flex justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <p className="bg-[#E9EBF8] py-[5px] px-[11px] text-xs leading-4 text-schestiPrimary rounded-full">
                      ...
                      <div className="flex items-center space-x-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <SenaryHeading
                            title={`${
                              bid.projectDuration
                            } ${bid.projectDurationType.toUpperCase()}`}
                            className="text-[#475467] font-semibold text-xs leading-4"
                          />
                        </div>
                        <div className="space-y-2">
            ...
            <div className="col-span-4  mt-3 rounded-lg p-4 border border-[#E8E3EF] shadow-lg bg-white">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="flex items-centers space-x-2">
                  ...
                  <SenaryHeading
                    title={`${
                      selectedBid.projectDuration
                    } ${selectedBid.projectDurationType.toUpperCase()}`}
                    className="font-semibold text-[#475467] text-xs leading-4"
                  />
                </div>
                <div className="flex items-centers space-x-2">
              ...
              {selectedBid.file?.url ? (
                <div className="px-4 space-y-2 mt-3">
                  <a
                    ...
                    className="rounded-[8px] flex justify-center border border-solid border-lavenderPurple bg-lavenderPurple text-white leading-6 font-semibold py-3 px-5  cursor-pointer shadow-scenarySubdued h-auto text-sm w-full"
                  >
                    Download File
                  </a>
                </div>
