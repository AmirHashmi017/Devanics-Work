...
import { rfiService } from 'src/services/rfi.service';
import TertiaryHeading from 'src/components/Headings/Tertiary';
import ExportProjectRFIs from '../../components/ExportProjectRFI';
import { InputComponent } from 'src/components/CustomInput/Input';
import { CreateRFI } from '../../components/CreateRFI';
import { UpdateRFI } from '../../components/UpdateRFI';
      ...
      {parentRfis
        ...
        .map((rfi) => {
          ...
          return (
            <div
              key={rfi._id}
              className="px-2 bg-white rounded-lg border shadow mt-4 space-y-2"
            >
              <div className="flex">
                <Avatar
                  src={
                ...
                <div className="py-4 flex-1 px-4 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      {rfi.type === 'private' ? (
                        <p className="py-[5px] rounded-full px-[11px] bg-[#E9EBF8] text-schestiPrimary text-xs leading-4">
                          Private
                        </p>
                      ) : null}
