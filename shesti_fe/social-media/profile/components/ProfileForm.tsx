      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <nav className="mb-6 text-sm">
          <Breadcrumb
            items={[
              {
                title: (
                  <a href="#" className="!text-[#007ab6] hover:underline">
                    Community
                  </a>
                ),
              },
        ...
        <div className="bg-white rounded-md shadow-sm p-8 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-center">
                      <CustomButton text="Add Education" className="w-fit" />
                    </div>
                        ...
                        <div className="flex justify-between">
                          <div>
                            ...
                            <p className="text-xs text-[#8c94a3]">
                              June 2019 - Jan 2022 · 2 yrs 3 mos
                            </p>
                          </div>
                          <button className="text-[#007ab6]">
                            <EditOutlined className="h-4 w-4" />
          ...
          <div className="flex items-center justify-end gap-4 mt-10">
            ...
            <CustomButton text="Save" className="!w-fit" />
          </div>
        </div>
      </div>
    </div>
