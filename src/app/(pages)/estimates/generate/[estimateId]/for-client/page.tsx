...
export default function GeneratedEstimateForClientPage() {
  return (
    <div>
...
// export default function GenerateEstimateForClientPage() {
...
//     enableReinitialize: mode === 'client',
//   });
...
//   return (
//     <div className="mx-auto w-full max-w-[500px] border" ref={containerRef}>
//       {/* Schesti logo */}
//       <div
...
//       <div className="flex justify-center mt-3 py-2 bg-schestiPrimary">
//         <Image
