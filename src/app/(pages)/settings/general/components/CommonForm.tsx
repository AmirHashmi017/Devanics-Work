...
type CommonGeneralSettingsFormType = Pick<
  IUserInterface,
  | 'companyName'
  | 'name'
  | 'website'
...
export function CommonGeneralSettingsForm() {
  const user = useUser();
  ...
  const formik = useFormik<CommonGeneralSettingsFormType>({
    initialValues: user
      ? {
    ...
    <div className="w-full pb-6">
      ...
      >
        ...
        <InputComponent
          ...
          field={{
            value: formik.values.industry ? formik.values.industry : undefined,
            onChange: formik.handleChange,
            onBlur: formik.handleBlur,
          }}
          hasError={formik.touched.industry && Boolean(formik.errors.industry)}
          errorMessage={
        ...
        <InputComponent
          ...
          field={{
            value: formik.values.employee ? formik.values.employee : undefined,
            onChange: formik.handleChange,
            onBlur: formik.handleBlur,
          }}
          hasError={formik.touched.employee && Boolean(formik.errors.employee)}
          errorMessage={
            formik.touched.employee && formik.errors.employee
              ? (formik.errors.employee as string)
              : ''
          }
        />
