  ...
  const handleMsrOprations = (
    ...
    try {
      if (type == 'create') {
        ...
        takeoffSummaryService.httpCreateMeasurement({
          ...data,
          takeoff: edit_id,
          pageId: selectedPage?.pageId,
        });
      } else if (type == 'update') {
        takeoffSummaryService.httpUpdateMeasurement(data?.id, data?.data);
      } else if (type == 'delete') {
        takeoffSummaryService.httpDeleteMeasurement(data?.id);
      } else {
