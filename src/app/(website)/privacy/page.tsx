...
export default function Privacy() {
  return (
    <>
      ...
      {/* second section */}
      <div className="mt-7 lg:mt-[44px]">
        <div className="pb-[80px] px-14 sm:px-[100px] text-center">
          <p className="font-normal font-Gilroy text-[15px] md:text-[18px] text-[#1D1D1DE5] leading-[25px] md:leading-[32px]">
            ...
            carefully before consenting to the processing of your personal data
            or submitting any personal information on our website, ensuring you
            fully understand our cooperation terms. This Privacy Policy governs
            your use of Schesti Services, as detailed in our Terms of Service.
            It explains how we process the personal data of users on the Schesti
            Platform, including usage, disclosure conditions, your data rights,
          ...
          <div className="px-6 lg:px-0 flex gap-2 lg:gap-10">
            <div className="relative w-full max-w-[308px] ">
              <div className="sticky top-5 w-full">
                <p className="font-medium cursor-pointer font-Gilroy text-[15px] md:text-[16px] text-[#1D1D1DE5] leading-[27px] text-left underline">
                  <Link href="#GENERAL-INFORMATION" className="cursor-pointer ">
                    GENERAL INFORMATION
                  </Link>
                </p>
                <p className="font-medium cursor-pointer pt-[10px] font-Gilroy text-[15px] md:text-[16px] text-[#1D1D1DE5] leading-[27px] text-left underline">
                  <Link
                ...
                <p className="font-medium cursor-pointer pt-[10px] font-Gilroy text-[15px] md:text-[16px] text-[#333E4F] leading-[27px] text-left underline">
            ...
            <div className="w-full max-w-[796px] pr-6">
              <h1
              ...
              <p className="font-normal pt-[10px] font-Gilroy text-[15px] md:text-[18px] text-[#1D1D1DE5] leading-[32px] text-left">
                ...
                secure and respectful treatment of your personal data.
              </p>
              <p className="font-normal pt-[10px] font-Gilroy text-[15px] md:text-[18px] text-[#1D1D1DE5] leading-[32px] text-left">
                We do not sell Personal Information. However, we may share your
                Personal Information with our partners, who may use your
                Personal Information to contact you, in their sole discretion.
              ...
              <p className="font-normal pt-[10px] font-Gilroy text-[15px] md:text-[18px] text-[#1D1D1DE5] leading-[32px] text-left">
                ...
                stay informed about any changes to it or other policies. Your
                use of the Services indicates your acceptance of the terms of
              ...
              <p className="font-normal pt-[10px] font-Gilroy text-[15px] md:text-[18px] text-[#1D1D1DE5] leading-[32px] text-left">
                ...
                <Link
                  className="ms-1.5 hover:underline"
