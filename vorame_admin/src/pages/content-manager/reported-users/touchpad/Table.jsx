...
import {GET_LOUNGE_REPORTS} from "services/constants"


export default function TouchpadTable({ searchTerm, limit }) {
  ...
  const fetchReports = useCallback(async () => {
    setLoading(true);
    try {
      const res = await api.get(`${GET_LOUNGE_REPORTS}`);
      ...
      <TableContainer component={Paper}
        ...
        >
          <TableHead sx={{ bgcolor: "#F4F7FA", }}>
            <TableRow>
              <TableCell sx={{ fontWeight: 500, p: 1.3 }}>Reported User(Touchpad) </TableCell>
