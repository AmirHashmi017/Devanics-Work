...
export const contactFormTemplate = (detail: Detail) => {
  return `
    <!DOCTYPE html>
<html lang="en">
...
<div class="email_container">
    ...
    <!-- Confirmation Title -->
    <h2>Subject: New Contact Form Submission</h2>
    <!-- Email Message -->
    <p>Hi, Admin!</p>
    <!-- Alert -->
        <p>A new contact form submission has been received.<br/>
        ...
        Please follow up with the sender at your earliest convenience.</p>
