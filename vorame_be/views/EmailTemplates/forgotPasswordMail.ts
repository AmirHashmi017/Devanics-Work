...
export const forgotPasswordTemplete = (detail: any) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
            ...
            <div style="height: 575px; padding: 27px 48px 50px 48px;background-color: rgba(255, 255, 255, 1);">
               <div style="padding: 40px 40px 214px 40px;">
                <div style="display: flex;flex-direction: column;gap: 18px;">
                    <h1 style="font-family: Inter;font-size: 16px;font-weight: 600;line-height: 24px;">Reset Your Schesti Password</h1>      
                </div>
                <div>
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;">Hi ${detail.email}, </p>
                     ${
                       detail.otp
                         ? `
                      <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" > You have requested to reset your password. Please enter the OTP below:</p>
                      <h1 style="font-family: Inter;font-size: 16px;font-weight: 600;line-height: 24px;"> ${detail.otp} </h1>
                    `
                         : `
                      <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" > You have requested to reset your password. Please click the button below:</p>
                      <a target="_blank" href="${detail.redirectLink}">
                        <button style="width:fit-content;height:40px;padding: 10px 16px 10px 16px;display: flex;justify-content: center;border-radius: 8px;border: 1px;background: rgba(127, 86, 217, 1);">
                          <span style="font-family: Inter;font-size: 14px;font-weight: 600;line-height: 20px; color: rgba(255, 255, 255, 1);">Reset Password</span>
                        </button>
                      </a>
                    `
                     }
...
//           <p>Hi, ${detail.email} </p>
//           <p>
//           It appears that there may be an issue with accessing your Schesti account.
//                 </p>
//           <p>
//           To reset your password and regain access, please follow the link provided below:
//                 </p>

//           <a target="_blank"  href="${detail.redirectLink}"><button class="email_btn">Reset Password</button></a>
//           <p class='cta_heading' >
