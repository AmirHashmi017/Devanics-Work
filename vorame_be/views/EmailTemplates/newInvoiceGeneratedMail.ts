...
import { NewInvoiceGeneratedEmailData } from '../../contants/types';
import { EmailTemplateFooter, EmailTemplateHeader } from './components';

export const newInvoiceGeneratedTemplate = (
  details: NewInvoiceGeneratedEmailData
) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
            ...
            <div style="height: 575px; padding: 27px 48px 50px 48px;background-color: rgba(255, 255, 255, 1);">
               <div style="padding: 40px 40px 214px 40px;">
                <div style="display: flex;flex-direction: column;gap: 18px;">
                    <h1 style="font-family: Inter;font-size: 16px;font-weight: 600;line-height: 24px;">New Invoice Generated</h1>      
                </div>
                <div>
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;">Hi ${details.name}, </p>
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" >We are pleased to inform you that a new invoice has been successfully generated.</p>
                    ...
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" >
                    Please review the invoice and take any necessary action. You can view and manage the invoice by logging into your Schesti account.
                    </p>
