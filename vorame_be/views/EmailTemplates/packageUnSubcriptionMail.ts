import { ClientUnSubscriptionEmailData } from '../../contants/types';
import { config } from '../../config/config';
import { EmailTemplateFooter, EmailTemplateHeader } from './components';

export const packageUnSubcription2 = (
  detail: ClientUnSubscriptionEmailData
) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
            ...
            <div style="height: 575px; padding: 27px 48px 50px 48px;background-color: rgba(255, 255, 255, 1);">
               <div style="padding: 40px 40px 214px 40px;">
                <div style="display: flex;flex-direction: column;gap: 18px;">
                    <h1 style="font-family: Inter;font-size: 16px;font-weight: 600;line-height: 24px;">Subscription Ended – Action Required to Renew</h1>      
                </div>
                <div>
                    ...
                    We hope you have found value in using Schesti. This is to inform you that your subscription plan ended on ${detail.endDate}.
                    </p>

                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" >
                    To continue enjoying uninterrupted access to our services, we invite you to renew your subscription plan.
                    </p>
                    
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" >
                    Thank you for your continued trust in Schesti.
                    </p>
...
export const packageUnSubcription = (detail: any) => {
  return `
      <!DOCTYPE html>
  <html lang="en">
  ...
  <div class="email_container">
      <div class="email_confirm">
          <h2>Package has been unsubcribed</h2>
          <p>Hi, ${detail.email} </p>
          <p>
          You have unsubcribe this package ${detail.name} 
                </p>
