...
export const newScheduledTemplete2 = (detail: {
  email: string;
  link: string;
  startTime: string;
  topic: string;
            ...
            <div style="height: 575px; padding: 27px 48px 50px 48px;background-color: rgba(255, 255, 255, 1);">
               <div style="padding: 40px 40px 214px 40px;">
                <div style="display: flex;flex-direction: column;gap: 18px;">
                    <h1 style="font-family: Inter;font-size: 16px;font-weight: 600;line-height: 24px;">Meeting Invitation</h1>      
                </div>
                <div>
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;">Hi ${detail.email}, </p>
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" > You have been invited to a meeting by ${detail.sender}
                    </p>
                   
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" > 
                    Meeting Subject: ${detail.topic} <br />
                    </p>
                    
                    <p style="font-family: Inter;font-size: 16px; font-weight: 400;line-height: 24px;" > 
                    Start Time: ${detail.startTime} ${detail.timezone}<br />
                    </p>
                    <a target="_blank"  href="${detail.link}">
                  <button style="width:fit-content;height:40px;padding: 10px 16px 10px 16px;display: flex;justify-content: center;border-radius: 8px;border: 1px;background: rgba(127, 86, 217, 1);"><span style="font-family: Inter;font-size: 14px;font-weight: 600;line-height: 20px; color: rgba(255, 255, 255, 1);">Join Meeting</span></button>
                  </a>
...
export const newScheduledTemplete = (detail: {
  email: string;
  link: string;
  startTime: string;
  topic: string;
  ...
  <div class="email_container">
      <div class="email_confirm">
          ...
          <p>Hi, ${detail.email} </p>
          <p>
          You have been invited to a meeting by ${detail.email} </p>
          <p>
          Meeting Subject: ${detail.topic} <br />
          Start Time: ${detail.startTime} ${detail.timezone}<br />
                </p>
          <a target="_blank"  href="${detail.link}"><button class="email_btn">Join now</button></a>
          <p class="cta_heading" > Regards,<br /> <span>Schesti</span></p>
